(function () {
    ...
    ShipmentPlanController.$inject = ['$scope', '$location', 'ShipmentPlanService'];
    function ShipmentPlanController($scope, $location, ShipmentPlanService) {
        ...
        $scope.fn_search_list = function () {
            ...
            ShipmentPlanService.search_shipmentplan(val).then(function (response) {
