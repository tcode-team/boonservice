                ...
                .EnableSwagger(c =>
                    {
                        ...
                        //
                        c.SingleApiVersion("v1", "boonservice.api");
                        c.IncludeXmlComments($@"{System.AppDomain.CurrentDomain.BaseDirectory}\bin\boonservice.api.XML");
                ...
                .EnableSwaggerUi(c =>
                    {
                        ...
                        c.InjectJavaScript(thisAssembly, "boonservice.api.CustomContent.basic-auth.js");
